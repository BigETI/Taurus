...
namespace Taurus.Connectors.WebSocket
{
    ...
    /// </summary>
    public sealed class WebSocketConnector : AConnector, IWebSocketConnector
    {
        /// <summary>
        /// Default fragmenter
        /// </summary>
        ...
        public static WebSocketConnector CreateNewWebSocketConnector(HandlePeerConnectionAttemptDelegate onHandlePeerConnectionAttempt) =>
        ...
        /// <param name="fragmenter">Fragmenter</param>
        /// <returns>New WebSocket connector</returns>
        public static WebSocketConnector CreateNewWebSocketConnector
        (
            HandlePeerConnectionAttemptDelegate onHandlePeerConnectionAttempt,
            IFragmenter fragmenter
