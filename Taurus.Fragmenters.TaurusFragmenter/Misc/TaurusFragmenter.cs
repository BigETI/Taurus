...
namespace Taurus.Fragmenters.TaurusFragmenter
{
    ...
    /// </summary>
    public sealed class TaurusFragmenter : AFragmenter, ITaurusFragmenter
    {
        /// <summary>
        /// Header "tAURUS\r\n"
        /// </summary>
        ...
        public override IDefragmenterStream CreateNewDefragmenterStream() => new TaurusDefragmenterStream();
    }
}
